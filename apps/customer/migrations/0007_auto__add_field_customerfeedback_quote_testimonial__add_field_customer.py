...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerFeedback.quote_testimonial'
        db.add_column('customer_customerfeedback', 'quote_testimonial',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'CustomerFeedback.type'
        db.add_column('customer_customerfeedback', 'type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerFeedback.quote_testimonial'
        db.delete_column('customer_customerfeedback', 'quote_testimonial')

        # Deleting field 'CustomerFeedback.type'
        db.delete_column('customer_customerfeedback', 'type')
