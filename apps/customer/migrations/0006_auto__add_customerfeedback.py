...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CustomerFeedback'
        db.create_table('customer_customerfeedback', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(related_name='feedback', unique=True, to=orm['order.Order'])),
        ...
        db.send_create_signal('customer', ['CustomerFeedback'])


    def backwards(self, orm):
        # Deleting model 'CustomerFeedback'
        db.delete_table('customer_customerfeedback')
