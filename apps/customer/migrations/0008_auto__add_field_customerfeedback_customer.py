...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomerFeedback.customer'
        db.add_column('customer_customerfeedback', 'customer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='feedbacks', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomerFeedback.customer'
        db.delete_column('customer_customerfeedback', 'customer_id')
    ...
    models = {
        ...
        'customer.customerfeedback': {
            'Meta': {'object_name': 'CustomerFeedback'},
            'customer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'feedbacks'", 'null': 'True', 'to': "orm['auth.User']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'feedback'", 'unique': 'True', 'to': "orm['order.Order']"}),
            ...
            'quote_testimonial': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
