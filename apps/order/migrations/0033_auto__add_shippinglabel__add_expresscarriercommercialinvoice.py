...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('order_shippinglabel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='labels', to=orm['order.Order'])),
        ...
        db.send_create_signal('order', ['ShippingLabel'])

        # Adding model 'ExpressCarrierCommercialInvoice'
        db.create_table('order_expresscarriercommercialinvoice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='commercial_invoices', to=orm['order.Order'])),
            ('original', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('order', ['ExpressCarrierCommercialInvoice'])


    def backwards(self, orm):
        # Deleting model 'ShippingLabel'
        db.delete_table('order_shippinglabel')

        # Deleting model 'ExpressCarrierCommercialInvoice'
        db.delete_table('order_expresscarriercommercialinvoice')
    ...
    models = {
        ...
        'order.expresscarriercommercialinvoice': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commercial_invoices'", 'to': "orm['order.Order']"}),
        ...
        'order.order': {
            ...
            'date_feedback_request_sent': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        'order.shippinglabel': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'labels'", 'to': "orm['order.Order']"}),
            'original': ('django.db.models.fields.files.FileField', [], {'max_length': '100'})
        },
