...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ShippingLabelBatch.created'
        db.delete_column('order_shippinglabelbatch', 'created')

        # Adding field 'ShippingLabelBatch.date_created'
        db.add_column('order_shippinglabelbatch', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 1, 24, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'ShippingLabelBatch.date_updated'
        db.add_column('order_shippinglabelbatch', 'date_updated',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ShippingLabelBatch.created'
        raise RuntimeError("Cannot reverse this migration. 'ShippingLabelBatch.created' and its values cannot be restored.")
        # Deleting field 'ShippingLabelBatch.date_created'
        db.delete_column('order_shippinglabelbatch', 'date_created')

        # Deleting field 'ShippingLabelBatch.date_updated'
        db.delete_column('order_shippinglabelbatch', 'date_updated')
    ...
    models = {
        ...
        'order.shippinglabelbatch': {
            ...
            'status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '4', 'db_index': 'True'})
        },
        'partner.partner': {
