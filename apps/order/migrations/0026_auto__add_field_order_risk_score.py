...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.risk_score'
        db.add_column('order_order', 'risk_score',
                      self.gf('django.db.models.fields.DecimalField')(default='-1', max_digits=5, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.risk_score'
        db.delete_column('order_order', 'risk_score')
    ...
    models = {
        ...
        'order.order': {
            ...
            'risk_score': ('django.db.models.fields.DecimalField', [], {'default': "'-1'", 'max_digits': '5', 'decimal_places': '2'}),
