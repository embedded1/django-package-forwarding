...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingLabel.order'
        db.alter_column('order_shippinglabel', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['order.Order']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ShippingLabel.order'
        raise RuntimeError("Cannot reverse this migration. 'ShippingLabel.order' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'ShippingLabel.order'
        db.alter_column('order_shippinglabel', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.Order']))
