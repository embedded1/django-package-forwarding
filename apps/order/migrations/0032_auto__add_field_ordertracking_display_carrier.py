...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderTracking.display_carrier'
        db.add_column('order_ordertracking', 'display_carrier',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderTracking.display_carrier'
        db.delete_column('order_ordertracking', 'display_carrier')
