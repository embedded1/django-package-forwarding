...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingLabelBatch.partner'
        db.add_column('order_shippinglabelbatch', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='batches', null=True, to=orm['partner.Partner']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingLabelBatch.partner'
        db.delete_column('order_shippinglabelbatch', 'partner_id')
