...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingLabelBatch.shipping_label'
        db.add_column('order_shippinglabelbatch', 'shipping_label',
                      self.gf('django.db.models.fields.files.FileField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingLabelBatch.shipping_label'
        db.delete_column('order_shippinglabelbatch', 'shipping_label')
    ...
    models = {
        ...
        'order.shippinglabelbatch': {
            ...
            'shipping_label': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
