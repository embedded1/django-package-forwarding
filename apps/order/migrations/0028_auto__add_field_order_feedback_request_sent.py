...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.feedback_request_sent'
        db.add_column('order_order', 'feedback_request_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.feedback_request_sent'
        db.delete_column('order_order', 'feedback_request_sent')
