...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.shipping_insurance_claim_issued'
        db.add_column('order_order', 'shipping_insurance_claim_issued',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.shipping_insurance_claim_issued'
        db.delete_column('order_order', 'shipping_insurance_claim_issued')
