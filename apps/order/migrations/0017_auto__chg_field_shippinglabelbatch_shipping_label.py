...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ShippingLabelBatch.shipping_label'
        db.alter_column('order_shippinglabelbatch', 'shipping_label', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'ShippingLabelBatch.shipping_label'
        db.alter_column('order_shippinglabelbatch', 'shipping_label', self.gf('django.db.models.fields.files.FileField')(default=None, max_length=100))
