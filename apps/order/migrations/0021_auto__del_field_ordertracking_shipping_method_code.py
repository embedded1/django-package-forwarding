...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrderTracking.shipping_method_code'
        db.delete_column('order_ordertracking', 'shipping_method_code')


    def backwards(self, orm):
        # Adding field 'OrderTracking.shipping_method_code'
        db.add_column('order_ordertracking', 'shipping_method_code',
