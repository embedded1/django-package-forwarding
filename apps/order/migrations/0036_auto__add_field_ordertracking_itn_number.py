...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderTracking.itn_number'
        db.add_column('order_ordertracking', 'itn_number',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderTracking.itn_number'
        db.delete_column('order_ordertracking', 'itn_number')
