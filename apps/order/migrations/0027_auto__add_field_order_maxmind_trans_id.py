...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.maxmind_trans_id'
        db.add_column('order_order', 'maxmind_trans_id',
                      self.gf('django.db.models.fields.CharField')(max_length=16, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.maxmind_trans_id'
        db.delete_column('order_order', 'maxmind_trans_id')
