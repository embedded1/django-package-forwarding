...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('order_shippingeventtype', 'is_required')

        # Deleting field 'ShippingEventType.sequence_number'
        db.delete_column('order_shippingeventtype', 'sequence_number')

        # Deleting field 'CommunicationEvent.date'
        db.delete_column('order_communicationevent', 'date')

        # Adding field 'CommunicationEvent.date_created'
        db.add_column('order_communicationevent', 'date_created',
        ...
        db.delete_column('order_paymenteventtype', 'sequence_number')

        # Deleting field 'PaymentEvent.date'
        db.delete_column('order_paymentevent', 'date')
        ...
        # Adding field 'PaymentEvent.date_created'
        db.add_column('order_paymentevent', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 14, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Order.currency'
        db.add_column('order_order', 'currency',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=12),
                      keep_default=False)

        # Adding field 'Order.shipping_code'
        db.add_column('order_order', 'shipping_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128, blank=True),
                      keep_default=False)


        # Changing field 'Order.billing_address'
        db.alter_column('order_order', 'billing_address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.BillingAddress'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Order.user'
        db.alter_column('order_order', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['auth.User']))

        # Changing field 'Order.shipping_address'
        db.alter_column('order_order', 'shipping_address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.ShippingAddress'], null=True, on_delete=models.SET_NULL))
        # Adding field 'Line.stockrecord'
        db.add_column('order_line', 'stockrecord',
        ...
        # Deleting field 'ShippingEvent.date'
        db.delete_column('order_shippingevent', 'date')

        # Adding field 'ShippingEvent.date_created'
        db.add_column('order_shippingevent', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 14, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'BillingAddress.postcode'
        db.alter_column('order_billingaddress', 'postcode', self.gf('oscar.models.fields.UppercaseCharField')(max_length=64, null=True))

        # Changing field 'ShippingAddress.phone_number'
        db.alter_column('order_shippingaddress', 'phone_number', self.gf('oscar.models.fields.PhoneNumberField')(default='03456134', max_length=128))

        # Changing field 'ShippingAddress.postcode'
        db.alter_column('order_shippingaddress', 'postcode', self.gf('oscar.models.fields.UppercaseCharField')(max_length=64, null=True))

    def backwards(self, orm):
        # Adding field 'ShippingEventType.is_required'
        db.add_column('order_shippingeventtype', 'is_required',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'ShippingEventType.sequence_number'
        db.add_column('order_shippingeventtype', 'sequence_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'CommunicationEvent.date'
        db.add_column('order_communicationevent', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 14, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'CommunicationEvent.date_created'
        db.delete_column('order_communicationevent', 'date_created')

        # Adding field 'PaymentEventType.sequence_number'
        db.add_column('order_paymenteventtype', 'sequence_number',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PaymentEvent.date'
        db.add_column('order_paymentevent', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 14, 0, 0), blank=True),
                      keep_default=False)
        ...
        # Deleting field 'PaymentEvent.date_created'
        db.delete_column('order_paymentevent', 'date_created')

        # Deleting field 'Order.currency'
        db.delete_column('order_order', 'currency')

        # Deleting field 'Order.shipping_code'
        db.delete_column('order_order', 'shipping_code')


        # Changing field 'Order.billing_address'
        db.alter_column('order_order', 'billing_address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.BillingAddress'], null=True))

        # Changing field 'Order.user'
        db.alter_column('order_order', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'Order.shipping_address'
        db.alter_column('order_order', 'shipping_address_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.ShippingAddress'], null=True))
        # Deleting field 'Line.stockrecord'
        db.delete_column('order_line', 'stockrecord_id')

        # Adding field 'ShippingEvent.date'
        db.add_column('order_shippingevent', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 2, 14, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'ShippingEvent.date_created'
        db.delete_column('order_shippingevent', 'date_created')
        ...
        # Changing field 'ShippingAddress.phone_number'
        db.alter_column('order_shippingaddress', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'condition': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        'order.shippinglabelbatch': {
            ...
            'status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '5', 'db_index': 'True'})
        },
        'partner.partner': {
