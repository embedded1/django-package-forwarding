...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'OrderTracking.latest_tracking_activity'
        db.delete_column('order_ordertracking', 'latest_tracking_activity')


    def backwards(self, orm):
        # Adding field 'OrderTracking.latest_tracking_activity'
        db.add_column('order_ordertracking', 'latest_tracking_activity',
