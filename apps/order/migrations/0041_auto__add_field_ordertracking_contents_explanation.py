...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderTracking.contents_explanation'
        db.add_column('order_ordertracking', 'contents_explanation',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderTracking.contents_explanation'
        db.delete_column('order_ordertracking', 'contents_explanation')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'merchant_zipcode': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '64', 'null': 'True', 'blank': 'True'}),
        ...
        'order.ordertracking': {
            ...
            'contents_explanation': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
