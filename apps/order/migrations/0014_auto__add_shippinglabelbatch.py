...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShippingLabelBatch'
        db.create_table('order_shippinglabelbatch', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('batch_id', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('status', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3, db_index=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('order', ['ShippingLabelBatch'])

        # Adding M2M table for field orders on 'ShippingLabelBatch'
        db.create_table('order_shippinglabelbatch_orders', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shippinglabelbatch', models.ForeignKey(orm['order.shippinglabelbatch'], null=False)),
            ('order', models.ForeignKey(orm['order.order'], null=False))
        ))
        db.create_unique('order_shippinglabelbatch_orders', ['shippinglabelbatch_id', 'order_id'])


    def backwards(self, orm):
        # Deleting model 'ShippingLabelBatch'
        db.delete_table('order_shippinglabelbatch')

        # Removing M2M table for field orders on 'ShippingLabelBatch'
        db.delete_table('order_shippinglabelbatch_orders')
    ...
    models = {
        ...
        'order.shippinglabelbatch': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orders': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'batch_ids'", 'symmetrical': 'False', 'to': "orm['order.Order']"}),
            'status': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '3', 'db_index': 'True'})
        },
        'partner.partner': {
