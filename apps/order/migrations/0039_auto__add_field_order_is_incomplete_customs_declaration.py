...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.is_incomplete_customs_declaration'
        db.add_column('order_order', 'is_incomplete_customs_declaration',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.is_incomplete_customs_declaration'
        db.delete_column('order_order', 'is_incomplete_customs_declaration')
