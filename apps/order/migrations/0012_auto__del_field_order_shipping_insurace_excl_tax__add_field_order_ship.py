...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.shipping_insurance_excl_tax'
        db.add_column('order_order', 'shipping_insurance_excl_tax',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.shipping_insurance_excl_tax'
        db.delete_column('order_order', 'shipping_insurance_excl_tax')
