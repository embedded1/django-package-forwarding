...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.shipping_surcharges'
        db.add_column('order_order', 'shipping_surcharges',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.shipping_surcharges'
        db.delete_column('order_order', 'shipping_surcharges')
