...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.date_feedback_request_sent'
        db.add_column('order_order', 'date_feedback_request_sent',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.date_feedback_request_sent'
        db.delete_column('order_order', 'date_feedback_request_sent')
