...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.package'
        db.add_column('order_order', 'package',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='order', null=True, to=orm['catalogue.Product']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.package'
        db.delete_column('order_order', 'package_id')
    ...
    models = {
        ...
        'order.order': {
            ...
            'package': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'order'", 'null': 'True', 'to': "orm['catalogue.Product']"}),
