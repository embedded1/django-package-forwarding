...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrderTracking'
        db.create_table('order_ordertracking', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tracking', to=orm['order.Order'])),
            ('tracking_number', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('shipment_id', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('latest_tracking_activity', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('shipping_method_code', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('carrier', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal('order', ['OrderTracking'])


    def backwards(self, orm):
        # Deleting model 'OrderTracking'
        db.delete_table('order_ordertracking')
    ...
    models = {
        ...
        'order.ordertracking': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'latest_tracking_activity': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tracking'", 'to': "orm['order.Order']"}),
            'shipment_id': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'shipping_method_code': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
