...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderTracking.order'
        db.alter_column('order_ordertracking', 'order_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['order.Order']))
        # Adding unique constraint on 'OrderTracking', fields ['order']
        db.create_unique('order_ordertracking', ['order_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'OrderTracking', fields ['order']
        db.delete_unique('order_ordertracking', ['order_id'])


        # Changing field 'OrderTracking.order'
        db.alter_column('order_ordertracking', 'order_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['order.Order']))
