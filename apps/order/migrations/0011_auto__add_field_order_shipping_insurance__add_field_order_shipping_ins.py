...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.shipping_insurance'
        db.add_column('order_order', 'shipping_insurance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.shipping_insurance_incl_tax'
        db.add_column('order_order', 'shipping_insurance_incl_tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Order.shipping_insurace_excl_tax'
        db.add_column('order_order', 'shipping_insurace_excl_tax',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Order.shipping_insurance'
        db.delete_column('order_order', 'shipping_insurance')

        # Deleting field 'Order.shipping_insurance_incl_tax'
        db.delete_column('order_order', 'shipping_insurance_incl_tax')

        # Deleting field 'Order.shipping_insurace_excl_tax'
        db.delete_column('order_order', 'shipping_insurace_excl_tax')
