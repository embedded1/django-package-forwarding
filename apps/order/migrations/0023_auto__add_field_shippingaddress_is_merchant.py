...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ShippingAddress.is_merchant'
        db.add_column('order_shippingaddress', 'is_merchant',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ShippingAddress.is_merchant'
        db.delete_column('order_shippingaddress', 'is_merchant')
