...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerOrderPaymentSettings.are_shipping_offers_apply'
        db.add_column('partner_partnerorderpaymentsettings', 'are_shipping_offers_apply',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerOrderPaymentSettings.are_shipping_offers_apply'
        db.delete_column('partner_partnerorderpaymentsettings', 'are_shipping_offers_apply')
    ...
    models = {
        ...
        'partner.partnerorderpaymentsettings': {
            ...
            'are_shipping_offers_apply': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
