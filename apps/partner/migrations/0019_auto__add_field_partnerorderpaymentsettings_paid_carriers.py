...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerOrderPaymentSettings.paid_carriers'
        db.add_column('partner_partnerorderpaymentsettings', 'paid_carriers',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerOrderPaymentSettings.paid_carriers'
        db.delete_column('partner_partnerorderpaymentsettings', 'paid_carriers')
    ...
    models = {
        ...
        'partner.partnerorderpaymentsettings': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'paid_carriers': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
