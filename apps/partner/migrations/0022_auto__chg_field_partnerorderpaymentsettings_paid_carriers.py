...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('partner_partnerorderpaymentsettings', 'paid_carriers', self.gf('oscar.models.fields.UppercaseCharField')(max_length=128))
    ...
    models = {
        ...
        'partner.partnerorderpaymentsettings': {
            ...
            'paid_carriers': ('oscar.models.fields.UppercaseCharField', [], {'max_length': '128'}),
