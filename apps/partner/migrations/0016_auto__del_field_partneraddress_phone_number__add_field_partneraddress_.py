...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PartnerAddress.phone_number1'
        db.add_column('partner_partneraddress', 'phone_number1',
                      self.gf('oscar.models.fields.PhoneNumberField')(default='', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'PartnerAddress.phone_number'
        raise RuntimeError("Cannot reverse this migration. 'PartnerAddress.phone_number' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PartnerAddress.phone_number'
        db.add_column('partner_partneraddress', 'phone_number',
                      self.gf('oscar.models.fields.PhoneNumberField')(max_length=128, blank=True),
                      keep_default=False)

        # Deleting field 'PartnerAddress.phone_number1'
        db.delete_column('partner_partneraddress', 'phone_number1')
    ...
    models = {
        ...
        'partner.partneraddress': {
            ...
            'phone_number1': ('oscar.models.fields.PhoneNumberField', [], {'max_length': '128', 'blank': 'True'}),
