...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PartnerOrderPaymentSettings'
        db.create_table('partner_partnerorderpaymentsettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('partner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='payments_settings', to=orm['partner.Partner'])),
            ('billing_email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('payment_gateway', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('shipping_margin', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
            ('services_margin', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=2)),
            ('paid_carriers', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('partner', ['PartnerOrderPaymentSettings'])

        #Adding field 'PartnerAddress.phone_number'
        db.add_column('partner_partneraddress', 'phone_number',
                      self.gf('oscar.models.fields.PhoneNumberField')(default='+7 968 881-52-65', max_length=128, blank=True),
                      keep_default=False)


    def backwards(self, orm):

        # Changing field 'PartnerOrderPaymentSettings.paid_carriers'
        db.alter_column('partner_partnerorderpaymentsettings', 'paid_carriers', self.gf('oscar.models.fields.UppercaseCharField')(max_length=32))

        # User chose to not deal with backwards NULL issues for 'PartnerAddress.phone_num'
        raise RuntimeError("Cannot reverse this migration. 'PartnerAddress.phone_num' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PartnerAddress.phone_num'
        db.add_column('partner_partneraddress', 'phone_num',
                      self.gf('oscar.models.fields.PhoneNumberField')(max_length=128, blank=True),
                      keep_default=False)

        # Deleting field 'PartnerAddress.phone_number'
        db.delete_column('partner_partneraddress', 'phone_number')
    ...
    models = {
        ...
        'partner.partnerorderpaymentsettings': {
            'Meta': {'object_name': 'PartnerOrderPaymentSettings'},
            'billing_email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'paid_carriers': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'partner': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'payments_settings'", 'to': "orm['partner.Partner']"}),
            'payment_gateway': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'services_margin': ('django.db.models.fields.DecimalField', [], {'max_digits': '4', 'decimal_places': '2'}),
            'shipping_margin': ('django.db.models.fields.DecimalField', [], {'max_digits': '4', 'decimal_places': '2'})
        },
        'partner.stockalert': {
