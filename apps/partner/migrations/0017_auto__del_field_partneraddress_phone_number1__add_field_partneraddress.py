...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'PartnerAddress.phone_number1'
        raise RuntimeError("Cannot reverse this migration. 'PartnerAddress.phone_number1' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'PartnerAddress.phone_number1'
