...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'PartnerAddress.notes'
        db.delete_column('partner_partneraddress', 'notes')


    def backwards(self, orm):
        # Adding field 'PartnerAddress.notes'
        db.add_column('partner_partneraddress', 'notes',
