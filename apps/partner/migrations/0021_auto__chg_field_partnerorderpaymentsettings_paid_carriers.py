...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'PartnerOrderPaymentSettings.paid_carriers'
        db.alter_column('partner_partnerorderpaymentsettings', 'paid_carriers', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        ...
        'partner.partnerorderpaymentsettings': {
            ...
            'paid_carriers': ('oscar.models.fields.UppercaseCharField', [], {'max_length': '32'}),
