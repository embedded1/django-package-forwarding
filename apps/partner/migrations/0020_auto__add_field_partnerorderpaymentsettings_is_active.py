...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartnerOrderPaymentSettings.is_active'
        db.add_column('partner_partnerorderpaymentsettings', 'is_active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartnerOrderPaymentSettings.is_active'
        db.delete_column('partner_partnerorderpaymentsettings', 'is_active')
