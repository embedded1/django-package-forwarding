...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('address_useraddress', 'phone_number', self.gf('oscar.models.fields.PhoneNumberField')(default='04567984', max_length=128))

        # Changing field 'UserAddress.postcode'
        db.alter_column('address_useraddress', 'postcode', self.gf('oscar.models.fields.UppercaseCharField')(max_length=64, null=True))
        # Adding unique constraint on 'UserAddress', fields ['user', 'hash']
        db.create_unique('address_useraddress', ['user_id', 'hash'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'UserAddress', fields ['user', 'hash']
        db.delete_unique('address_useraddress', ['user_id', 'hash'])


        # Changing field 'UserAddress.phone_number'
        db.alter_column('address_useraddress', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
