...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AffiliatorAddress'
        db.create_table('address_affiliatoraddress', (
            ...
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(related_name='affiliate_address', unique=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('address', ['AffiliatorAddress'])


        # Changing field 'UserAddress.is_merchant'
        db.alter_column('address_useraddress', 'is_merchant', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):
        # Deleting model 'AffiliatorAddress'
        db.delete_table('address_affiliatoraddress')


        # Changing field 'UserAddress.is_merchant'
        db.alter_column('address_useraddress', 'is_merchant', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    models = {
        'address.affiliatoraddress': {
            'Meta': {'object_name': 'AffiliatorAddress'},
            ...
            'user': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'affiliate_address'", 'unique': 'True', 'to': "orm['auth.User']"})
        },
        'address.country': {
