...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserAddress.is_merchant'
        db.add_column('address_useraddress', 'is_merchant',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserAddress.is_merchant'
        db.delete_column('address_useraddress', 'is_merchant')
    ...
    models = {
        ...
        'address.useraddress': {
            ...
            'is_merchant': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
