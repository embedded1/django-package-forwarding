...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basket.type'
        db.add_column('basket_basket', 'type',
                      self.gf('django.db.models.fields.CharField')(default='International Delivery', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Basket.type'
        db.delete_column('basket_basket', 'type')
    ...
    models = {
        ...
        'basket.basket': {
            ...
            'type': ('django.db.models.fields.CharField', [], {'default': "'International Delivery'", 'max_length': '128'}),
        ...
        'basket.line': {
            ...
            'stockrecord': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'basket_lines'", 'null': 'True', 'to': "orm['partner.StockRecord']"})
        },
