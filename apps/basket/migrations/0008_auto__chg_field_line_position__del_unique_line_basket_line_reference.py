...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Line.position'
        db.alter_column('basket_line', 'position', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'Line.position'
        db.alter_column('basket_line', 'position', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
