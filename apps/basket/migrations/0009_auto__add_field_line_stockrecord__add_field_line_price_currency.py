...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('basket_line', 'stockrecord',
        ...
        db.add_column('basket_line', 'price_currency',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('basket_line', 'stockrecord_id')

        # Deleting field 'Line.price_currency'
        db.delete_column('basket_line', 'price_currency')
