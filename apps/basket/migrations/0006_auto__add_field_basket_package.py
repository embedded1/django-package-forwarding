...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Basket.package'
        db.add_column('basket_basket', 'package',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Basket.package'
        db.delete_column('basket_basket', 'package_id')
    ...
    models = {
        ...
        'basket.basket': {
            ...
            'package': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.Product']", 'null': 'True', 'blank': 'True'}),
        ...
        'catalogue.productclass': {
            ...
            'basket_position': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
