...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.referral'
        db.add_column('user_profile', 'referral',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['referrals.Referral'], unique=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.short_referral_url'
        db.add_column('user_profile', 'short_referral_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.referral'
        db.delete_column('user_profile', 'referral_id')

        # Deleting field 'Profile.short_referral_url'
        db.delete_column('user_profile', 'short_referral_url')
