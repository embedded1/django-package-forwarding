...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.registration_method'
        db.add_column('user_profile', 'registration_method',
                      self.gf('django.db.models.fields.CharField')(default='Email', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.registration_method'
        db.delete_column('user_profile', 'registration_method')
