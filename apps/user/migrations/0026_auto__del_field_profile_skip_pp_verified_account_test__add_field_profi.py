...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profile.remaining_invites'
        db.add_column('user_profile', 'remaining_invites',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profile.remaining_invites'
        db.delete_column('user_profile', 'remaining_invites')
