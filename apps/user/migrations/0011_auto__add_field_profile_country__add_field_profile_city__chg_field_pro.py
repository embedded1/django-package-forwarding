...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('user_profile', 'country',
                      self.gf('django.db.models.fields.CharField')(max_length=3, null=True),
                      keep_default=False)

        # Adding field 'Profile.city'
        db.add_column('user_profile', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


        # Changing field 'Profile.custom_requests_details'
        db.alter_column('user_profile', 'custom_requests_details', self.gf('sanitizer.models.SanitizedTextField')(null=True))
        # Adding index on 'Profile', fields ['express_checkout_done']
        db.create_index('user_profile', ['express_checkout_done'])


        # Changing field 'Profile.is_custom_requests'
        db.alter_column('user_profile', 'is_custom_requests', self.gf('sanitizer.models.SanitizedTextField')(null=True))

    def backwards(self, orm):
        # Removing index on 'Profile', fields ['express_checkout_done']
        db.delete_index('user_profile', ['express_checkout_done'])

        # Deleting field 'Profile.country'
        db.delete_column('user_profile', 'country')

        # Deleting field 'Profile.city'
        db.delete_column('user_profile', 'city')


        # Changing field 'Profile.custom_requests_details'
        db.alter_column('user_profile', 'custom_requests_details', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Profile.is_custom_requests'
        db.alter_column('user_profile', 'is_custom_requests', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'user.profile': {
            ...
            'custom_requests_details': ('sanitizer.models.SanitizedTextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'is_custom_requests': ('sanitizer.models.SanitizedTextField', [], {'null': 'True', 'blank': 'True'}),
