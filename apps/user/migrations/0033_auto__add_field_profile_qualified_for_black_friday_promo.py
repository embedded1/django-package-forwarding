...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.qualified_for_black_friday_promo'
        db.add_column('user_profile', 'qualified_for_black_friday_promo',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.qualified_for_black_friday_promo'
        db.delete_column('user_profile', 'qualified_for_black_friday_promo')
