...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.qualified_for_exclusive_club_offers'
        db.add_column('user_profile', 'qualified_for_exclusive_club_offers',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.qualified_for_exclusive_club_offers'
        db.delete_column('user_profile', 'qualified_for_exclusive_club_offers')
    ...
    models = {
        ...
        'user.profile': {
            ...
            'qualified_for_exclusive_club_offers': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
