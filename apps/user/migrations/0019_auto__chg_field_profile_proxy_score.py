...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.proxy_score'
        #db.alter_column('user_profile', 'proxy_score', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))
        #db.execute(
        #    'update "user_profile" set proxy_score=null where proxy_score='''
        #)
        db.execute(
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Profile.proxy_score'
        db.alter_column('user_profile', 'proxy_score', self.gf('django.db.models.fields.CharField')(max_length=8, null=True))
    ...
    models = {
        ...
        'user.profile': {
            ...
            'proxy_score': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2', 'blank': 'True'}),
