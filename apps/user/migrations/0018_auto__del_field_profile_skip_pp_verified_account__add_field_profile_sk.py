...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.skip_pp_verified_account'
        db.delete_column('user_profile', 'skip_pp_verified_account')

        # Adding field 'Profile.skip_pp_verified_account_test'
        db.add_column('user_profile', 'skip_pp_verified_account_test',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.skip_pp_verified_account'
        db.add_column('user_profile', 'skip_pp_verified_account',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Profile.skip_pp_verified_account_test'
        db.delete_column('user_profile', 'skip_pp_verified_account_test')
    ...
    models = {
        ...
        'user.profile': {
            ...
            'proxy_score': ('django.db.models.fields.CharField', [], {'max_length': '8', 'null': 'True', 'blank': 'True'}),
