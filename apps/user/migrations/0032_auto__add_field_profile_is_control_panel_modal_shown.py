...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.is_control_panel_modal_shown'
        db.add_column('user_profile', 'is_control_panel_modal_shown',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.is_control_panel_modal_shown'
        db.delete_column('user_profile', 'is_control_panel_modal_shown')
