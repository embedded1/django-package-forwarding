...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountAuthenticationDocument'
        db.create_table('user_accountauthenticationdocument', (
            ...
            ('account_status', self.gf('django.db.models.fields.related.ForeignKey')(related_name='auth_documents', to=orm['user.AccountStatus'])),
        ))
        db.send_create_signal('user', ['AccountAuthenticationDocument'])

        # Adding model 'AccountStatus'
        db.create_table('user_accountstatus', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('verification_status', self.gf('django.db.models.fields.CharField')(default='Unverified', max_length=128, db_index=True)),
            ('account_profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='account_status', unique=True, to=orm['user.Profile'])),
        ))
        db.send_create_signal('user', ['AccountStatus'])


    def backwards(self, orm):
        # Deleting model 'AccountAuthenticationDocument'
        db.delete_table('user_accountauthenticationdocument')

        # Deleting model 'AccountStatus'
        db.delete_table('user_accountstatus')
    ...
    models = {
        ...
        'user.accountstatus': {
            ...
            'account_profile': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'account_status'", 'unique': 'True', 'to': "orm['user.Profile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
