...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.is_account_setup_completed'
        db.add_column('user_profile', 'is_account_setup_completed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.is_account_setup_completed'
        db.delete_column('user_profile', 'is_account_setup_completed')
