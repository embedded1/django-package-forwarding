...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.external_referer'
        db.add_column('user_profile', 'external_referer',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.external_referer'
        db.delete_column('user_profile', 'external_referer')
