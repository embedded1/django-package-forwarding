...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.registration_type'
        db.add_column('user_profile', 'registration_type',
                      self.gf('django.db.models.fields.CharField')(default='N/A', max_length=16),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.registration_type'
        db.delete_column('user_profile', 'registration_type')
