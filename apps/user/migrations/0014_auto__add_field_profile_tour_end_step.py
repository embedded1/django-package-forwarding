...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.tour_end_step'
        db.add_column('user_profile', 'tour_end_step',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.tour_end_step'
        db.delete_column('user_profile', 'tour_end_step')
