...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountStatus.date_created'
        db.add_column('user_accountstatus', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 9, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountStatus.date_created'
        db.delete_column('user_accountstatus', 'date_created')
