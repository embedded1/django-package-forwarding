...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.added_chrome_extension'
        db.add_column('user_profile', 'added_chrome_extension',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.added_chrome_extension'
        db.delete_column('user_profile', 'added_chrome_extension')
