...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'GoogleAdwordsCampaignData'
        db.delete_table('user_googleadwordscampaigndata')

        # Adding model 'GoogleAnalyticsData'
        db.create_table('user_googleanalyticsdata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='adwords_data', unique=True, to=orm['user.Profile'])),
            ('number', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True)),
            ('medium', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True)),
            ('term', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True)),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True)),
        ))
        db.send_create_signal('user', ['GoogleAnalyticsData'])


    def backwards(self, orm):
        # Adding model 'GoogleAdwordsCampaignData'
        db.create_table('user_googleadwordscampaigndata', (
            ('content', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True)),
            ('profile', self.gf('django.db.models.fields.related.OneToOneField')(related_name='adwords_data', unique=True, to=orm['user.Profile'])),
            ('term', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True, db_index=True)),
        ...
        db.send_create_signal('user', ['GoogleAdwordsCampaignData'])

        # Deleting model 'GoogleAnalyticsData'
        db.delete_table('user_googleanalyticsdata')
    ...
    models = {
        ...
        'user.googleanalyticsdata': {
            'Meta': {'object_name': 'GoogleAnalyticsData'},
            'content': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'medium': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'db_index': 'True'}),
            'number': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'db_index': 'True'}),
            'profile': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'adwords_data'", 'unique': 'True', 'to': "orm['user.Profile']"}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'db_index': 'True'}),
            'term': ('django.db.models.fields.CharField', [], {'max_length': '256', 'null': 'True', 'db_index': 'True'})
        },
        'user.potentialuser': {
        ...
        'user.profile': {
            ...
            'account_type': ('django.db.models.fields.CharField', [], {'default': "'Personal'", 'max_length': '32'}),
            ...
            'external_referer': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'is_account_setup_completed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_consolidate_every_new_package': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_control_panel_modal_shown': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'qualified_for_black_friday_promo': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'referral': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['referrals.Referral']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'registration_method': ('django.db.models.fields.CharField', [], {'default': "'Email'", 'max_length': '32'}),
            'registration_type': ('django.db.models.fields.CharField', [], {'default': "'N/A'", 'max_length': '16'}),
