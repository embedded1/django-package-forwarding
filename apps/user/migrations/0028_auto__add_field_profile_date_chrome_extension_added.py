...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.date_chrome_extension_added'
        db.add_column('user_profile', 'date_chrome_extension_added',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.date_chrome_extension_added'
        db.delete_column('user_profile', 'date_chrome_extension_added')
