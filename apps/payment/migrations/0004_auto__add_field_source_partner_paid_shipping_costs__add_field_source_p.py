...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.partner_paid_shipping_costs'
        db.add_column('payment_source', 'partner_paid_shipping_costs',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Source.partner_paid_shipping_insurance'
        db.add_column('payment_source', 'partner_paid_shipping_insurance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.partner_paid_shipping_costs'
        db.delete_column('payment_source', 'partner_paid_shipping_costs')

        # Deleting field 'Source.partner_paid_shipping_insurance'
        db.delete_column('payment_source', 'partner_paid_shipping_insurance')
    ...
    models = {
        ...
        'payment.source': {
            ...
            'partner_paid_shipping_costs': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'partner_paid_shipping_insurance': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'partner_share': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'}),
            'reference': ('django.db.models.fields.CharField', [], {'max_length': '128', 'blank': 'True'}),
            'self_share': ('django.db.models.fields.DecimalField', [], {'default': "'0.00'", 'max_digits': '12', 'decimal_places': '2'}),
            'source_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sources'", 'to': "orm['payment.SourceType']"})
        },
        'payment.sourcetype': {
