...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.partner_paid'
        db.add_column('payment_source', 'partner_paid',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.partner_paid'
        db.delete_column('payment_source', 'partner_paid')
    ...
    models = {
        ...
        'payment.source': {
            ...
            'partner_paid': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
