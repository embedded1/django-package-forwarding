...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Source.self_share'
        db.add_column('payment_source', 'self_share',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Source.partner_share'
        db.add_column('payment_source', 'partner_share',
                      self.gf('django.db.models.fields.DecimalField')(default='0.00', max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Source.self_share'
        db.delete_column('payment_source', 'self_share')

        # Deleting field 'Source.partner_share'
        db.delete_column('payment_source', 'partner_share')
