...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.is_contain_prohibited_items'
        db.add_column('catalogue_product', 'is_contain_prohibited_items',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.is_contain_prohibited_items'
        db.delete_column('catalogue_product', 'is_contain_prohibited_items')
