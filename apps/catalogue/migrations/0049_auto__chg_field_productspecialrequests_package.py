...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductSpecialRequests.package'
        db.alter_column('catalogue_productspecialrequests', 'package_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['catalogue.Product']))

    def backwards(self, orm):

        # Changing field 'ProductSpecialRequests.package'
        db.alter_column('catalogue_productspecialrequests', 'package_id', self.gf('django.db.models.fields.related.OneToOneField')(default=None, unique=True, to=orm['catalogue.Product']))
