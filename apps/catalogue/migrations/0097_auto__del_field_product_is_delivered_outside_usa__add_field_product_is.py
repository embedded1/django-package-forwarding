...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.is_delivered_outside_usa'
        db.delete_column('catalogue_product', 'is_delivered_outside_usa')

        # Adding field 'Product.is_sent_outside_usa'
        db.add_column('catalogue_product', 'is_sent_outside_usa',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.is_delivered_outside_usa'
        db.add_column('catalogue_product', 'is_delivered_outside_usa',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.is_sent_outside_usa'
        db.delete_column('catalogue_product', 'is_sent_outside_usa')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'is_contain_prohibited_items': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'is_discountable': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'is_sent_outside_usa': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
