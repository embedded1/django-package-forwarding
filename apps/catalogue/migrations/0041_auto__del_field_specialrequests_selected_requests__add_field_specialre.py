...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SpecialRequests.selected_requests'
        db.delete_column('catalogue_specialrequests', 'selected_requests')

        # Adding field 'SpecialRequests.selected_requests_count'
        db.add_column('catalogue_specialrequests', 'selected_requests_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SpecialRequests.selected_requests'
        db.add_column('catalogue_specialrequests', 'selected_requests',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'SpecialRequests.selected_requests_count'
        db.delete_column('catalogue_specialrequests', 'selected_requests_count')
