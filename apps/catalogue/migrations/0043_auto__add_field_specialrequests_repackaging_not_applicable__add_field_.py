...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpecialRequests.repackaging_not_applicable'
        db.add_column('catalogue_specialrequests', 'repackaging_not_applicable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SpecialRequests.custom_requests_not_applicable'
        db.add_column('catalogue_specialrequests', 'custom_requests_not_applicable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpecialRequests.repackaging_not_applicable'
        db.delete_column('catalogue_specialrequests', 'repackaging_not_applicable')

        # Deleting field 'SpecialRequests.custom_requests_not_applicable'
        db.delete_column('catalogue_specialrequests', 'custom_requests_not_applicable')
