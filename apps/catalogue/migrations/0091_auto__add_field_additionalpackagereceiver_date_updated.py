...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdditionalPackageReceiver.date_updated'
        db.add_column('catalogue_additionalpackagereceiver', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2015, 9, 18, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdditionalPackageReceiver.date_updated'
        db.delete_column('catalogue_additionalpackagereceiver', 'date_updated')
