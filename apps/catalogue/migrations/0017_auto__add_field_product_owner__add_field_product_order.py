...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalogue_product', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.order'
        db.add_column('catalogue_product', 'order',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='package', unique=True, null=True, to=orm['order.Order']),
                      keep_default=False)

        # Adding M2M table for field combined_products on 'Product'
        db.create_table('catalogue_product_combined_products', (
        ...
        db.create_unique('catalogue_product_combined_products', ['from_product_id', 'to_product_id'])


    def backwards(self, orm):
        # Deleting field 'Product.owner'
        db.delete_column('catalogue_product', 'owner_id')

        # Deleting field 'Product.order'
        db.delete_column('catalogue_product', 'order_id')

        # Removing M2M table for field combined_products on 'Product'
        db.delete_table('catalogue_product_combined_products')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'combined_products': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'combined_packages'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['catalogue.Product']"}),
        ...
        'order.order': {
            ...
            'shipping_insurace_excl_tax': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2'}),
