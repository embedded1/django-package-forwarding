...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductSpecialRequests.is_photos'
        db.add_column('catalogue_productspecialrequests', 'is_photos',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductSpecialRequests.is_photos'
        db.delete_column('catalogue_productspecialrequests', 'is_photos')
