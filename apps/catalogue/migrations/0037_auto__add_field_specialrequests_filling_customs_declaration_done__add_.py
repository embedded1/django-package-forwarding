...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpecialRequests.filling_customs_declaration_done'
        db.add_column('catalogue_specialrequests', 'filling_customs_declaration_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SpecialRequests.photos_done'
        db.add_column('catalogue_specialrequests', 'photos_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpecialRequests.filling_customs_declaration_done'
        db.delete_column('catalogue_specialrequests', 'filling_customs_declaration_done')

        # Deleting field 'SpecialRequests.photos_done'
        db.delete_column('catalogue_specialrequests', 'photos_done')
