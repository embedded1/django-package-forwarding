...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductSpecialRequests.custom_requests_details'
        db.alter_column('catalogue_productspecialrequests', 'custom_requests_details', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'ProductSpecialRequests.custom_requests_details'
        db.alter_column('catalogue_productspecialrequests', 'custom_requests_details', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'catalogue.productspecialrequests': {
            ...
            'custom_requests_details': ('django.db.models.fields.TextField', [], {}),
