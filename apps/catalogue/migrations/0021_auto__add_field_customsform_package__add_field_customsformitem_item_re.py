...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomsForm.package'
        db.add_column('catalogue_customsform', 'package',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='customs_form', unique=True, null=True, to=orm['catalogue.Product']),
                      keep_default=False)

        # Removing M2M table for field items on 'CustomsForm'
        db.delete_table('catalogue_customsform_items')

        # Adding field 'CustomsFormItem.item_reference'
        db.add_column('catalogue_customsformitem', 'item_reference',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=128, db_index=True),
                      keep_default=False)

        # Adding field 'CustomsFormItem.customs_form'
        db.add_column('catalogue_customsformitem', 'customs_form',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='items', to=orm['catalogue.CustomsForm']),
                      keep_default=False)

        # Adding unique constraint on 'CustomsFormItem', fields ['customs_form', 'item_reference']
        db.create_unique('catalogue_customsformitem', ['customs_form_id', 'item_reference'])

        # Deleting field 'Product.customs_form'
        db.delete_column('catalogue_product', 'customs_form_id')


    def backwards(self, orm):
        # Removing unique constraint on 'CustomsFormItem', fields ['customs_form', 'item_reference']
        db.delete_unique('catalogue_customsformitem', ['customs_form_id', 'item_reference'])

        # Deleting field 'CustomsForm.package'
        db.delete_column('catalogue_customsform', 'package_id')

        # Adding M2M table for field items on 'CustomsForm'
        db.create_table('catalogue_customsform_items', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('customsform', models.ForeignKey(orm['catalogue.customsform'], null=False)),
            ('customsformitem', models.ForeignKey(orm['catalogue.customsformitem'], null=False))
        ))
        db.create_unique('catalogue_customsform_items', ['customsform_id', 'customsformitem_id'])

        # Deleting field 'CustomsFormItem.item_reference'
        db.delete_column('catalogue_customsformitem', 'item_reference')

        # Deleting field 'CustomsFormItem.customs_form'
        db.delete_column('catalogue_customsformitem', 'customs_form_id')

        # Adding field 'Product.customs_form'
        db.add_column('catalogue_product', 'customs_form',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.CustomsForm'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'catalogue.customsform': {
            'Meta': {'object_name': 'CustomsForm'},
        ...
        'catalogue.customsformitem': {
            'Meta': {'unique_together': "(('customs_form', 'item_reference'),)", 'object_name': 'CustomsFormItem'},
            'customs_form': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'items'", 'to': "orm['catalogue.CustomsForm']"}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item_reference': ('django.db.models.fields.CharField', [], {'max_length': '128', 'db_index': 'True'}),
