...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExpressCarrierCommercialInvoice.shipping_label'
        db.delete_column('catalogue_expresscarriercommercialinvoice', 'shipping_label_id')

        # Adding field 'ExpressCarrierCommercialInvoice.package'
        db.add_column('catalogue_expresscarriercommercialinvoice', 'package',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=804, related_name='commercial_invoices', to=orm['catalogue.Product']),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'ExpressCarrierCommercialInvoice.shipping_label'
        raise RuntimeError("Cannot reverse this migration. 'ExpressCarrierCommercialInvoice.shipping_label' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ExpressCarrierCommercialInvoice.shipping_label'
        db.add_column('catalogue_expresscarriercommercialinvoice', 'shipping_label',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoices', to=orm['catalogue.ProductShippingLabel']),
                      keep_default=False)

        # Deleting field 'ExpressCarrierCommercialInvoice.package'
        db.delete_column('catalogue_expresscarriercommercialinvoice', 'package_id')
    ...
    models = {
        ...
        'catalogue.expresscarriercommercialinvoice': {
            'Meta': {'object_name': 'ExpressCarrierCommercialInvoice'},
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'package': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'commercial_invoices'", 'to': "orm['catalogue.Product']"})
        },
        'catalogue.option': {
