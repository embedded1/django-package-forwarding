...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.is_delivered_outside_usa'
        db.alter_column('catalogue_product', 'is_delivered_outside_usa', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Product.is_contain_prohibited_items'
        db.alter_column('catalogue_product', 'is_contain_prohibited_items', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Product.is_delivered_outside_usa'
        db.alter_column('catalogue_product', 'is_delivered_outside_usa', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Product.is_contain_prohibited_items'
        db.alter_column('catalogue_product', 'is_contain_prohibited_items', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'is_delivered_outside_usa': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
