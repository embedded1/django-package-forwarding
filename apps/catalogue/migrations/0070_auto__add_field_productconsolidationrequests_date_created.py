...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductConsolidationRequests.date_created'
        db.add_column('catalogue_productconsolidationrequests', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 9, 27, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductConsolidationRequests.date_created'
        db.delete_column('catalogue_productconsolidationrequests', 'date_created')
