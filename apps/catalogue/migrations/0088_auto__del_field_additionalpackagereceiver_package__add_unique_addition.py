...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AdditionalPackageReceiver.package'
        db.delete_column('catalogue_additionalpackagereceiver', 'package_id')
        ...
        # Deleting field 'Product.is_name_matched'
        db.delete_column('catalogue_product', 'is_name_matched')

        # Adding field 'Product.additional_receiver'
        db.add_column('catalogue_product', 'additional_receiver',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='additional_receiver_packages', null=True, to=orm['catalogue.AdditionalPackageReceiver']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'AdditionalPackageReceiver.package'
        raise RuntimeError("Cannot reverse this migration. 'AdditionalPackageReceiver.package' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'AdditionalPackageReceiver.package'
        db.add_column('catalogue_additionalpackagereceiver', 'package',
                      self.gf('django.db.models.fields.related.OneToOneField')(related_name='additional_receiver', unique=True, to=orm['catalogue.Product']),
                      keep_default=False)

        # Adding field 'Product.is_name_matched'
        db.add_column('catalogue_product', 'is_name_matched',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Product.additional_receiver'
        db.delete_column('catalogue_product', 'additional_receiver_id')
    ...
    models = {
        ...
        'catalogue.additionalpackagereceiver': {
            'Meta': {'unique_together': "(('account_holder', 'first_name', 'last_name'),)", 'object_name': 'AdditionalPackageReceiver'},
            'account_holder': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'additional_receivers'", 'to': "orm['auth.User']"}),
