...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'ProductSpecialRequests', fields ['express_checkout_done']
        db.create_index('catalogue_productspecialrequests', ['express_checkout_done'])


    def backwards(self, orm):
        # Removing index on 'ProductSpecialRequests', fields ['express_checkout_done']
        db.delete_index('catalogue_productspecialrequests', ['express_checkout_done'])
