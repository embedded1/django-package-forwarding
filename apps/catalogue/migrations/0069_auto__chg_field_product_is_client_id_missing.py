...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.is_client_id_missing'
        db.alter_column('catalogue_product', 'is_client_id_missing', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Product.is_client_id_missing'
        db.alter_column('catalogue_product', 'is_client_id_missing', self.gf('django.db.models.fields.BooleanField')())
