...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalogue_product', 'condition',
                      self.gf('django.db.models.fields.CharField')(default='Great', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.condition'
        db.delete_column('catalogue_product', 'condition')
