...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'SpecialRequests', fields ['is_express_checkout']
        db.create_index('catalogue_specialrequests', ['is_express_checkout'])


    def backwards(self, orm):
        # Removing index on 'SpecialRequests', fields ['is_express_checkout']
        db.delete_index('catalogue_specialrequests', ['is_express_checkout'])
