...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PackageLocation.package'
        db.alter_column('catalogue_packagelocation', 'package_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['catalogue.Product']))
        # Adding unique constraint on 'PackageLocation', fields ['package']
        db.create_unique('catalogue_packagelocation', ['package_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'PackageLocation', fields ['package']
        db.delete_unique('catalogue_packagelocation', ['package_id'])


        # Changing field 'PackageLocation.package'
        db.alter_column('catalogue_packagelocation', 'package_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product']))
