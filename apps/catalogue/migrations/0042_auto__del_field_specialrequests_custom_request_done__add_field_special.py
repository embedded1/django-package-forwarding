...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SpecialRequests.custom_requests_done'
        db.add_column('catalogue_specialrequests', 'custom_requests_done',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SpecialRequests.custom_requests_done'
        db.delete_column('catalogue_specialrequests', 'custom_requests_done')
