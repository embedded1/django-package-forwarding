...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.merchant_zipcode'
        db.add_column('catalogue_product', 'merchant_zipcode',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=64, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.merchant_zipcode'
        db.delete_column('catalogue_product', 'merchant_zipcode')
