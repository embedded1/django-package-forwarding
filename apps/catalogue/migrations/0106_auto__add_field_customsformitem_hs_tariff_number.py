...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomsFormItem.hs_tariff_number'
        db.add_column('catalogue_customsformitem', 'hs_tariff_number',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomsFormItem.hs_tariff_number'
        db.delete_column('catalogue_customsformitem', 'hs_tariff_number')
    ...
    models = {
        ...
        'catalogue.customsformitem': {
            ...
            'hs_tariff_number': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
