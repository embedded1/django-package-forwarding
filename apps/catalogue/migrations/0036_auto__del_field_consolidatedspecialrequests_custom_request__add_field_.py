...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ConsolidatedSpecialRequests.custom_request'
        db.delete_column('catalogue_consolidatedspecialrequests', 'custom_request')

        # Adding field 'ConsolidatedSpecialRequests.custom_requests'
        db.add_column('catalogue_consolidatedspecialrequests', 'custom_requests',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ConsolidatedSpecialRequests.custom_request_done'
        db.add_column('catalogue_consolidatedspecialrequests', 'custom_request_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'SpecialRequests.custom_request'
        db.delete_column('catalogue_specialrequests', 'custom_request')

        # Adding field 'SpecialRequests.repackaging_done'
        db.add_column('catalogue_specialrequests', 'repackaging_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SpecialRequests.custom_requests'
        db.add_column('catalogue_specialrequests', 'custom_requests',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'SpecialRequests.custom_request_done'
        db.add_column('catalogue_specialrequests', 'custom_request_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ConsolidatedSpecialRequests.custom_request'
        db.add_column('catalogue_consolidatedspecialrequests', 'custom_request',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ConsolidatedSpecialRequests.custom_requests'
        db.delete_column('catalogue_consolidatedspecialrequests', 'custom_requests')

        # Deleting field 'ConsolidatedSpecialRequests.custom_request_done'
        db.delete_column('catalogue_consolidatedspecialrequests', 'custom_request_done')

        # Adding field 'SpecialRequests.custom_request'
        db.add_column('catalogue_specialrequests', 'custom_request',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'SpecialRequests.repackaging_done'
        db.delete_column('catalogue_specialrequests', 'repackaging_done')

        # Deleting field 'SpecialRequests.custom_requests'
        db.delete_column('catalogue_specialrequests', 'custom_requests')

        # Deleting field 'SpecialRequests.custom_request_done'
        db.delete_column('catalogue_specialrequests', 'custom_request_done')
    ...
    models = {
        ...
        'catalogue.consolidatedspecialrequests': {
            ...
            'custom_request_done': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'custom_requests': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'catalogue.specialrequests': {
            'Meta': {'object_name': 'SpecialRequests'},
            'custom_request_done': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'custom_requests': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
