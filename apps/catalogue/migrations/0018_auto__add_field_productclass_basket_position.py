...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductClass.basket_position'
        db.add_column('catalogue_productclass', 'basket_position',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductClass.basket_position'
        db.delete_column('catalogue_productclass', 'basket_position')
