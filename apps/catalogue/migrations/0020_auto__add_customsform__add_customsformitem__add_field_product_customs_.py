...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CustomsFormItem'
        db.create_table('catalogue_customsformitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('catalogue', ['CustomsFormItem'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CustomsFormItem'
        db.delete_table('catalogue_customsformitem')
    ...
    models = {
        ...
        'catalogue.customsform': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['catalogue.CustomsFormItem']", 'symmetrical': 'False'})
        },
        ...
        'catalogue.product': {
            ...
            'customs_form': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['catalogue.CustomsForm']", 'null': 'True', 'blank': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
