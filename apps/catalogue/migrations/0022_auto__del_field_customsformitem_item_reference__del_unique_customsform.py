...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'CustomsFormItem.item_reference'
        raise RuntimeError("Cannot reverse this migration. 'CustomsFormItem.item_reference' and its values cannot be restored.")
