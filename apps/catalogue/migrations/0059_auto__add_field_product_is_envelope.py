...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.is_envelope'
        db.add_column('catalogue_product', 'is_envelope',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.is_envelope'
        db.delete_column('catalogue_product', 'is_envelope')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'is_envelope': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
