...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('catalogue_productspecialrequests', 'is_photos', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

    def backwards(self, orm):

        # Changing field 'ProductSpecialRequests.is_photos'
        db.alter_column('catalogue_productspecialrequests', 'is_photos', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))
    ...
    models = {
        ...
        'catalogue.productspecialrequests': {
            ...
            'is_photos': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '16', 'null': 'True', 'blank': 'True'}),
