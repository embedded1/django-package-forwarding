...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpecialRequests.date_updated'
        db.add_column('catalogue_specialrequests', 'date_updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 12, 16, 0, 0), db_index=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'SpecialRequests.date_updated'
        db.delete_column('catalogue_specialrequests', 'date_updated')
