...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductSpecialRequests.is_photos'
        db.execute(
            'ALTER TABLE "catalogue_productspecialrequests" '
            'ALTER COLUMN "is_photos" DROP DEFAULT, '
            'ALTER COLUMN "is_photos" DROP NOT NULL, '
            'ALTER COLUMN "is_photos" TYPE varchar USING (is_photos::varchar)'
        )
        db.alter_column('catalogue_productspecialrequests', 'is_photos', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'ProductSpecialRequests.is_photos'
        db.alter_column('catalogue_productspecialrequests', 'is_photos', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
    ...
    models = {
        ...
        'catalogue.productspecialrequests': {
            ...
            'is_photos': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32', 'blank': 'True'}),
