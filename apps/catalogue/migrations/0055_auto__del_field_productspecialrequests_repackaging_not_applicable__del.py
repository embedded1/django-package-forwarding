...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductSpecialRequests.repackaging_not_applicable'
        db.delete_column('catalogue_productspecialrequests', 'repackaging_not_applicable')

        # Deleting field 'ProductSpecialRequests.custom_requests_not_applicable'
        db.delete_column('catalogue_productspecialrequests', 'custom_requests_not_applicable')


    def backwards(self, orm):
        # Adding field 'ProductSpecialRequests.repackaging_not_applicable'
        db.add_column('catalogue_productspecialrequests', 'repackaging_not_applicable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProductSpecialRequests.custom_requests_not_applicable'
        db.add_column('catalogue_productspecialrequests', 'custom_requests_not_applicable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
