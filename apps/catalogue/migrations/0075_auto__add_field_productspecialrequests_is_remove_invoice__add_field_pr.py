...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductSpecialRequests.is_remove_invoice'
        db.add_column('catalogue_productspecialrequests', 'is_remove_invoice',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'ProductSpecialRequests.remove_invoice_done'
        db.add_column('catalogue_productspecialrequests', 'remove_invoice_done',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ProductSpecialRequests.is_extra_protection'
        db.add_column('catalogue_productspecialrequests', 'is_extra_protection',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

        # Adding field 'ProductSpecialRequests.extra_protection_done'
        db.add_column('catalogue_productspecialrequests', 'extra_protection_done',
                      self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductSpecialRequests.is_remove_invoice'
        db.delete_column('catalogue_productspecialrequests', 'is_remove_invoice')

        # Deleting field 'ProductSpecialRequests.remove_invoice_done'
        db.delete_column('catalogue_productspecialrequests', 'remove_invoice_done')

        # Deleting field 'ProductSpecialRequests.is_extra_protection'
        db.delete_column('catalogue_productspecialrequests', 'is_extra_protection')

        # Deleting field 'ProductSpecialRequests.extra_protection_done'
        db.delete_column('catalogue_productspecialrequests', 'extra_protection_done')
