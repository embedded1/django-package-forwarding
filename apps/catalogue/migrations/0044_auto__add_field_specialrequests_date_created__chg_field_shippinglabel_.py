...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpecialRequests.date_created'
        db.add_column('catalogue_specialrequests', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, default=datetime.datetime(2013, 12, 16, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'ShippingLabel.date_created'
        db.alter_column('catalogue_shippinglabel', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'SpecialRequests.date_created'
        db.delete_column('catalogue_specialrequests', 'date_created')


        # Changing field 'ShippingLabel.date_created'
        db.alter_column('catalogue_shippinglabel', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
