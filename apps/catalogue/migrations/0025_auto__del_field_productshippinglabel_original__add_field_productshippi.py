...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductShippingLabel.original'
        db.delete_column('catalogue_productshippinglabel', 'original')

        # Adding field 'ProductShippingLabel.label'
        db.add_column('catalogue_productshippinglabel', 'label',
                      self.gf('django.db.models.fields.files.FileField')(default=0, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProductShippingLabel.original'
        db.add_column('catalogue_productshippinglabel', 'original',
                      self.gf('django.db.models.fields.files.FileField')(default=0, max_length=100),
                      keep_default=False)

        # Deleting field 'ProductShippingLabel.label'
        db.delete_column('catalogue_productshippinglabel', 'label')
    ...
    models = {
        ...
        'catalogue.productshippinglabel': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
