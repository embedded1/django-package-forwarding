...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalogue_product', 'order',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='order', unique=True, null=True, to=orm['order.Order']),
                      keep_default=False)
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'order': ('django.db.models.fields.related.OneToOneField', [], {'blank': 'True', 'related_name': "'order'", 'unique': 'True', 'null': 'True', 'to': "orm['order.Order']"}),
