...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductConsolidationRequests.is_keep_retail_packaging'
        db.delete_column('catalogue_productconsolidationrequests', 'is_keep_retail_packaging')

        # Deleting field 'ProductConsolidationRequests.is_remove_all_packaging'
        db.delete_column('catalogue_productconsolidationrequests', 'is_remove_all_packaging')

        # Adding field 'ProductConsolidationRequests.packaging'
        db.add_column('catalogue_productconsolidationrequests', 'packaging',
                      self.gf('django.db.models.fields.CharField')(default='Keep', max_length=64),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProductConsolidationRequests.is_keep_retail_packaging'
        db.add_column('catalogue_productconsolidationrequests', 'is_keep_retail_packaging',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'ProductConsolidationRequests.is_remove_all_packaging'
        db.add_column('catalogue_productconsolidationrequests', 'is_remove_all_packaging',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'ProductConsolidationRequests.packaging'
        db.delete_column('catalogue_productconsolidationrequests', 'packaging')
    ...
    models = {
        ...
        'catalogue.productconsolidationrequests': {
            ...
            'packaging': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
