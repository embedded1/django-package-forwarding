...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.date_consolidated'
        db.add_column('catalogue_product', 'date_consolidated',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.date_consolidated'
        db.delete_column('catalogue_product', 'date_consolidated')
