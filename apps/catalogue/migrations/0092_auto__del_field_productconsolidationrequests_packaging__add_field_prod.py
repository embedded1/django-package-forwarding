...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ProductConsolidationRequests.item_packing'
        db.add_column('catalogue_productconsolidationrequests', 'item_packing',
                      self.gf('django.db.models.fields.CharField')(default='Keep', max_length=64),
                      keep_default=False)

        # Adding field 'ProductConsolidationRequests.container'
        db.add_column('catalogue_productconsolidationrequests', 'container',
                      self.gf('django.db.models.fields.CharField')(default='One box', max_length=64),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProductConsolidationRequests.item_packing'
        db.delete_column('catalogue_productconsolidationrequests', 'item_packing')

        # Deleting field 'ProductConsolidationRequests.container'
        db.delete_column('catalogue_productconsolidationrequests', 'container')
