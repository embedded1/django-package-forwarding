...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SpecialRequests.is_custom_requests'
        db.add_column('catalogue_specialrequests', 'is_custom_requests',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SpecialRequests.is_custom_requests'
        db.delete_column('catalogue_specialrequests', 'is_custom_requests')
