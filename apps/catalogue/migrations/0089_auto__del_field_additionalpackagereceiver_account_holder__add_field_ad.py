...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'AdditionalPackageReceiver', fields ['account_holder', 'first_name', 'last_name']
        db.delete_unique('catalogue_additionalpackagereceiver', ['account_holder_id', 'first_name', 'last_name'])

        # Deleting field 'AdditionalPackageReceiver.account_holder'
        db.delete_column('catalogue_additionalpackagereceiver', 'account_holder_id')

        # Adding field 'AdditionalPackageReceiver.package_owner'
        db.add_column('catalogue_additionalpackagereceiver', 'package_owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='additional_receivers', to=orm['auth.User']),
                      keep_default=False)

        # Adding unique constraint on 'AdditionalPackageReceiver', fields ['package_owner', 'first_name', 'last_name']
        db.create_unique('catalogue_additionalpackagereceiver', ['package_owner_id', 'first_name', 'last_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'AdditionalPackageReceiver', fields ['package_owner', 'first_name', 'last_name']
        db.delete_unique('catalogue_additionalpackagereceiver', ['package_owner_id', 'first_name', 'last_name'])


        # User chose to not deal with backwards NULL issues for 'AdditionalPackageReceiver.account_holder'
        raise RuntimeError("Cannot reverse this migration. 'AdditionalPackageReceiver.account_holder' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'AdditionalPackageReceiver.account_holder'
        db.add_column('catalogue_additionalpackagereceiver', 'account_holder',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='additional_receivers', to=orm['auth.User']),
                      keep_default=False)

        # Deleting field 'AdditionalPackageReceiver.package_owner'
        db.delete_column('catalogue_additionalpackagereceiver', 'package_owner_id')

        # Adding unique constraint on 'AdditionalPackageReceiver', fields ['account_holder', 'first_name', 'last_name']
        db.create_unique('catalogue_additionalpackagereceiver', ['account_holder_id', 'first_name', 'last_name'])
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'additional_receiver': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'additional_receiver_packages'", 'null': 'True', 'to': "orm['catalogue.AdditionalPackageReceiver']"}),
        ...
        'catalogue.productconsolidationrequests': {
            ...
            'packaging': ('django.db.models.fields.CharField', [], {'default': "'Keep'", 'max_length': '64'})
        },
