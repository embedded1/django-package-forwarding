...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductShippingLabel.label'
        db.alter_column('catalogue_productshippinglabel', 'label', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ProductShippingLabel.label'
        db.alter_column('catalogue_productshippinglabel', 'label', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'catalogue.productshippinglabel': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
