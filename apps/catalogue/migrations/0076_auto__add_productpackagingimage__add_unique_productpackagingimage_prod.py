...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductPackagingImage'
        db.create_table('catalogue_productpackagingimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='packaging_images', to=orm['catalogue.Product'])),
        ...
        db.send_create_signal('catalogue', ['ProductPackagingImage'])

        # Adding unique constraint on 'ProductPackagingImage', fields ['product', 'display_order']
        db.create_unique('catalogue_productpackagingimage', ['product_id', 'display_order'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProductPackagingImage', fields ['product', 'display_order']
        db.delete_unique('catalogue_productpackagingimage', ['product_id', 'display_order'])

        # Deleting model 'ProductPackagingImage'
        db.delete_table('catalogue_productpackagingimage')
