...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.is_client_id_missing'
        db.add_column('catalogue_product', 'is_client_id_missing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.is_client_id_missing'
        db.delete_column('catalogue_product', 'is_client_id_missing')
