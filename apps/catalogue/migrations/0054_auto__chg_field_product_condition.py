...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Product.condition'
        db.alter_column('catalogue_product', 'condition', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Product.condition'
        db.alter_column('catalogue_product', 'condition', self.gf('django.db.models.fields.CharField')(default='Great', max_length=128))
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'condition': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
