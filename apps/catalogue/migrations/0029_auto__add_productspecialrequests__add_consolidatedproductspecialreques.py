...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalogue_productspecialrequests', (
            ...
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='special_requests', to=orm['catalogue.Product'])),
        ...
        db.create_table('catalogue_consolidatedproductspecialrequests', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consolidate_special_requests', to=orm['catalogue.Product'])),
    ...
    models = {
        ...
        'catalogue.consolidatedproductspecialrequests': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'consolidate_special_requests'", 'to': "orm['catalogue.Product']"})
        },
        ...
        'catalogue.productspecialrequests': {
            ...
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'special_requests'", 'to': "orm['catalogue.Product']"})
        },
