...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'ConsolidatedProductSpecialRequests'
        db.delete_table('catalogue_consolidatedproductspecialrequests')
        ...
        # Adding model 'ConsolidatedSpecialRequests'
        db.create_table('catalogue_consolidatedspecialrequests', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('package', self.gf('django.db.models.fields.related.OneToOneField')(related_name='consolidate_special_requests', unique=True, to=orm['catalogue.Product'])),
            ('is_keep_retail_packaging', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_remove_all_packaging', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_use_only_one_package', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('custom_request', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('catalogue', ['ConsolidatedSpecialRequests'])
        ...
        db.create_table('catalogue_specialrequests', (
            ...
            ('is_express_checkout', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_table('catalogue_shippinglabel', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('product', self.gf('django.db.models.fields.related.ForeignKey')(related_name='labels', to=orm['catalogue.Product'])),
    ...
    def backwards(self, orm):
        # Adding model 'ConsolidatedProductSpecialRequests'
        db.create_table('catalogue_consolidatedproductspecialrequests', (
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(related_name='consolidate_special_requests', unique=True, to=orm['catalogue.Product'])),
            ('is_use_only_one_package', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('custom_request', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('is_keep_retail_packaging', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_remove_all_packaging', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.send_create_signal('catalogue', ['ConsolidatedProductSpecialRequests'])

        # Adding model 'ProductSpecialRequests'
        db.create_table('catalogue_productspecialrequests', (
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(related_name='special_requests', unique=True, to=orm['catalogue.Product'])),
            ('is_filling_customs_declaration', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_express_checkout', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('custom_request', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('is_repackaging', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        # Deleting model 'ConsolidatedSpecialRequests'
        db.delete_table('catalogue_consolidatedspecialrequests')
