...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AdditionalPackageReceiver.date_created'
        db.add_column('catalogue_additionalpackagereceiver', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 9, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AdditionalPackageReceiver.date_created'
        db.delete_column('catalogue_additionalpackagereceiver', 'date_created')
