...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ConsolidatedProductSpecialRequests.product'
        db.alter_column('catalogue_consolidatedproductspecialrequests', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['catalogue.Product']))
        # Adding unique constraint on 'ConsolidatedProductSpecialRequests', fields ['product']
        db.create_unique('catalogue_consolidatedproductspecialrequests', ['product_id'])


        # Changing field 'ProductSpecialRequests.product'
        db.alter_column('catalogue_productspecialrequests', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, to=orm['catalogue.Product']))
        # Adding unique constraint on 'ProductSpecialRequests', fields ['product']
        db.create_unique('catalogue_productspecialrequests', ['product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ProductSpecialRequests', fields ['product']
        db.delete_unique('catalogue_productspecialrequests', ['product_id'])

        # Removing unique constraint on 'ConsolidatedProductSpecialRequests', fields ['product']
        db.delete_unique('catalogue_consolidatedproductspecialrequests', ['product_id'])


        # Changing field 'ConsolidatedProductSpecialRequests.product'
        db.alter_column('catalogue_consolidatedproductspecialrequests', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product']))

        # Changing field 'ProductSpecialRequests.product'
        db.alter_column('catalogue_productspecialrequests', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product']))
    ...
    models = {
        ...
        'catalogue.consolidatedproductspecialrequests': {
            'Meta': {'object_name': 'ConsolidatedProductSpecialRequests'},
            'custom_request': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'product': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'consolidate_special_requests'", 'unique': 'True', 'to': "orm['catalogue.Product']"})
        },
        ...
        'catalogue.productshippinglabel': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'labels'", 'to': "orm['catalogue.Product']"})
        },
        'catalogue.productspecialrequests': {
            ...
            'product': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'special_requests'", 'unique': 'True', 'to': "orm['catalogue.Product']"})
        },
