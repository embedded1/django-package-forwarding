...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalogue_packagelocation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('package', self.gf('django.db.models.fields.related.ForeignKey')(related_name='location', to=orm['catalogue.Product'])),
            ('warehouse', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('loc1', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('loc2', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('loc3', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
        ))
        db.send_create_signal('catalogue', ['PackageLocation'])


    def backwards(self, orm):
        # Deleting model 'PackageLocation'
        db.delete_table('catalogue_packagelocation')
    ...
    models = {
        ...
        'catalogue.packagelocation': {
            ...
            'package': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'location'", 'to': "orm['catalogue.Product']"}),
            'warehouse': ('django.db.models.fields.CharField', [], {'max_length': '64'})
        },
