...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductSpecialRequests.repackaging_done'
        db.alter_column('catalogue_productspecialrequests', 'repackaging_done', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'ProductSpecialRequests.custom_requests_done'
        db.alter_column('catalogue_productspecialrequests', 'custom_requests_done', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'ProductSpecialRequests.repackaging_done'
        db.alter_column('catalogue_productspecialrequests', 'repackaging_done', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ProductSpecialRequests.custom_requests_done'
        db.alter_column('catalogue_productspecialrequests', 'custom_requests_done', self.gf('django.db.models.fields.BooleanField')())
