...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'PackageReceiver'
        db.delete_table('catalogue_packagereceiver')

        # Adding model 'AdditionalPackageReceiver'
        db.create_table('catalogue_additionalpackagereceiver', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('package', self.gf('django.db.models.fields.related.OneToOneField')(related_name='additional_receiver', unique=True, to=orm['catalogue.Product'])),
            ('account_holder', self.gf('django.db.models.fields.related.ForeignKey')(related_name='additional_receivers', to=orm['auth.User'])),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=30, db_index=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=30, db_index=True)),
            ('verification_status', self.gf('django.db.models.fields.CharField')(default='Unverified', max_length=128, db_index=True)),
        ))
        db.send_create_signal('catalogue', ['AdditionalPackageReceiver'])


        # Changing field 'PackageReceiverDocument.receiver'
        db.alter_column('catalogue_packagereceiverdocument', 'receiver_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.AdditionalPackageReceiver']))

    def backwards(self, orm):
        # Adding model 'PackageReceiver'
        db.create_table('catalogue_packagereceiver', (
            ('verification_status', self.gf('django.db.models.fields.CharField')(default='Unverified', max_length=128, db_index=True)),
            ('first_name', self.gf('django.db.models.fields.CharField')(max_length=30, db_index=True)),
            ('last_name', self.gf('django.db.models.fields.CharField')(max_length=30, db_index=True)),
            ('account_holder', self.gf('django.db.models.fields.related.ForeignKey')(related_name='additional_receivers', to=orm['auth.User'])),
        ...
        db.send_create_signal('catalogue', ['PackageReceiver'])

        # Deleting model 'AdditionalPackageReceiver'
        db.delete_table('catalogue_additionalpackagereceiver')


        # Changing field 'PackageReceiverDocument.receiver'
        db.alter_column('catalogue_packagereceiverdocument', 'receiver_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['catalogue.PackageReceiver']))
    ...
    models = {
        ...
        'catalogue.additionalpackagereceiver': {
            'Meta': {'object_name': 'AdditionalPackageReceiver'},
            ...
            'package': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'additional_receiver'", 'unique': 'True', 'to': "orm['catalogue.Product']"}),
        ...
        'catalogue.product': {
            ...
            'is_name_matched': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
