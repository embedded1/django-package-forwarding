...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SpecialRequests.date_created'
        db.alter_column('catalogue_specialrequests', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'SpecialRequests.date_created'
        db.alter_column('catalogue_specialrequests', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True))
