...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProductSpecialRequests.is_photos'
        db.alter_column('catalogue_productspecialrequests', 'is_photos', self.gf('django.db.models.fields.CharField')(default=None, max_length=32))
    ...
    models = {
        ...
        'catalogue.productspecialrequests': {
            ...
            'is_photos': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
