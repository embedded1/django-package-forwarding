...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.is_contain_lithium_battery'
        db.delete_column('catalogue_product', 'is_contain_lithium_battery')

        # Adding field 'Product.battery_status'
        db.add_column('catalogue_product', 'battery_status',
                      self.gf('django.db.models.fields.CharField')(default='No Battery', max_length=32),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Product.is_contain_lithium_battery'
        db.add_column('catalogue_product', 'is_contain_lithium_battery',
                      self.gf('django.db.models.fields.CharField')(default='No Battery', max_length=32),
                      keep_default=False)

        # Deleting field 'Product.battery_status'
        db.delete_column('catalogue_product', 'battery_status')
