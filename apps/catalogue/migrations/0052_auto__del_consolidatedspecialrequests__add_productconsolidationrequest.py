...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProductConsolidationRequests'
        db.create_table('catalogue_productconsolidationrequests', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('package', self.gf('django.db.models.fields.related.OneToOneField')(related_name='consolidation_requests', unique=True, to=orm['catalogue.Product'])),
        ...
        db.send_create_signal('catalogue', ['ProductConsolidationRequests'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ProductConsolidationRequests'
        db.delete_table('catalogue_productconsolidationrequests')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'condition': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
