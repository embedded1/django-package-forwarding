...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('catalogue_expresscarriercommercialinvoice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('shipping_label', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invoices', to=orm['catalogue.ProductShippingLabel'])),
            ('invoice', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('catalogue', ['ExpressCarrierCommercialInvoice'])


    def backwards(self, orm):
        # Deleting model 'ExpressCarrierCommercialInvoice'
        db.delete_table('catalogue_expresscarriercommercialinvoice')
