...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Product.is_contain_lithium_battery'
        db.alter_column('catalogue_product', 'is_contain_lithium_battery', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'is_contain_lithium_battery': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
