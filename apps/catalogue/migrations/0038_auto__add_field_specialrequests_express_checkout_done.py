...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SpecialRequests.express_checkout_done'
        db.add_column('catalogue_specialrequests', 'express_checkout_done',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SpecialRequests.express_checkout_done'
        db.delete_column('catalogue_specialrequests', 'express_checkout_done')
