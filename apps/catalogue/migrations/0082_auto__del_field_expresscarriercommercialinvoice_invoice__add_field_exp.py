...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ExpressCarrierCommercialInvoice.invoice'
        db.delete_column('catalogue_expresscarriercommercialinvoice', 'invoice')

        # Adding field 'ExpressCarrierCommercialInvoice.original'
        db.add_column('catalogue_expresscarriercommercialinvoice', 'original',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'ExpressCarrierCommercialInvoice.invoice'
        raise RuntimeError("Cannot reverse this migration. 'ExpressCarrierCommercialInvoice.invoice' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'ExpressCarrierCommercialInvoice.invoice'
        db.add_column('catalogue_expresscarriercommercialinvoice', 'invoice',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100),
                      keep_default=False)

        # Deleting field 'ExpressCarrierCommercialInvoice.original'
        db.delete_column('catalogue_expresscarriercommercialinvoice', 'original')
    ...
    models = {
        ...
        'catalogue.expresscarriercommercialinvoice': {
            ...
            'shipping_label': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'invoices'", 'to': "orm['catalogue.ProductShippingLabel']"})
        },
        'catalogue.option': {
