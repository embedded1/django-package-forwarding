...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductCustomsForm.content_type'
        db.alter_column('catalogue_productcustomsform', 'content_type', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'ProductCustomsForm.content_type'
        db.alter_column('catalogue_productcustomsform', 'content_type', self.gf('django.db.models.fields.CharField')(default='Gift', max_length=128))
    ...
    models = {
        ...
        'catalogue.productcustomsform': {
            ...
            'content_type': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True'}),
            'date_created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
