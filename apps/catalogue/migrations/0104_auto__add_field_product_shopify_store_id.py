...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.shopify_store_id'
        db.add_column('catalogue_product', 'shopify_store_id',
                      self.gf('django.db.models.fields.IntegerField')(db_index=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.shopify_store_id'
        db.delete_column('catalogue_product', 'shopify_store_id')
