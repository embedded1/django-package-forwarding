...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductShippingLabel.original'
        db.alter_column('catalogue_productshippinglabel', 'original', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'ProductShippingLabel.original'
        db.alter_column('catalogue_productshippinglabel', 'original', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
