...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalogue_productattributevalue', 'value_file',
        ...
        db.add_column('catalogue_productattributevalue', 'value_image',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('catalogue_productattributevalue', 'value_file')

        # Deleting field 'ProductAttributeValue.value_image'
        db.delete_column('catalogue_productattributevalue', 'value_image')
