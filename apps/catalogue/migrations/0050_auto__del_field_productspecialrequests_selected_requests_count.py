...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProductSpecialRequests.selected_requests_count'
        db.delete_column('catalogue_productspecialrequests', 'selected_requests_count')


    def backwards(self, orm):
        # Adding field 'ProductSpecialRequests.selected_requests_count'
        db.add_column('catalogue_productspecialrequests', 'selected_requests_count',
