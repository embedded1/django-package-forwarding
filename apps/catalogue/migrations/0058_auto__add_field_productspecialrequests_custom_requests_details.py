...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductSpecialRequests.custom_requests_details'
        db.add_column('catalogue_productspecialrequests', 'custom_requests_details',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProductSpecialRequests.custom_requests_details'
        db.delete_column('catalogue_productspecialrequests', 'custom_requests_details')
