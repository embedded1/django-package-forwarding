...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PackageReceiverDocument'
        db.create_table('catalogue_packagereceiverdocument', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('receiver', self.gf('django.db.models.fields.related.ForeignKey')(related_name='documents', null=True, to=orm['catalogue.PackageReceiver'])),
        ...
        db.send_create_signal('catalogue', ['PackageReceiverDocument'])
    ...
    def backwards(self, orm):
        # Deleting model 'PackageReceiverDocument'
        db.delete_table('catalogue_packagereceiverdocument')
    ...
    models = {
        ...
        'catalogue.packagereceiver': {
            'Meta': {'object_name': 'PackageReceiver'},
        ...
        'catalogue.packagereceiverdocument': {
            ...
            'receiver': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'documents'", 'null': 'True', 'to': "orm['catalogue.PackageReceiver']"})
        },
        'catalogue.product': {
