...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProductSpecialRequests.is_express_checkout'
        db.add_column('catalogue_productspecialrequests', 'is_express_checkout',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Product.is_express_checkout'
        db.delete_column('catalogue_product', 'is_express_checkout')


    def backwards(self, orm):
        # Deleting field 'ProductSpecialRequests.is_express_checkout'
        db.delete_column('catalogue_productspecialrequests', 'is_express_checkout')

        # Adding field 'Product.is_express_checkout'
        db.add_column('catalogue_product', 'is_express_checkout',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
